...
capital_letters = [i for i in sentence if i in capitals]
...
random_lists = [[random.randrange(1, 100) for i in range(10)] for i in range(0,5)]
print(random_lists)
...
flatten_list = []
flat = [flatten_list.append(e) for i in list_of_lists for e in i]
print(flatten_list)
