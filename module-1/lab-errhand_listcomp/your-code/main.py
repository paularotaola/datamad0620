...
power_two = [2**i for i in range(50)]
print(power_two)
...
cl = "abcdefghijklmnñopqrstuvwxyz "
sentence = 'The Quick Brown Fox Jumped Over The Lazy Dog'
capital_letters = "".join([i for i in sentence if i not in cl])
...
consontants = "".join([i for i in sentence if i in vowels])
print(consontants)
...
# Remember to use list comprehensions and to print your results.
files = [folder for folder in os.walk("../../../")]
print(files[:10])
